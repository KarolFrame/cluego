      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 w-[90vw] max-w-xl -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white dark:bg-gray-900 p-6 shadow-xl">
          ...
          <div className="space-y-4 text-sm opacity-80 max-h-[60vh] overflow-y-auto">
            ...
            <h3 className="font-semibold">{t("legal.terms_allowed")}</h3>
            <p>{t("legal.terms_allowed_text")}</p>

            <h3 className="font-semibold">{t("legal.terms_not_allowed")}</h3>
            <p>{t("legal.terms_not_allowed_text")}</p>

            <h3 className="font-semibold">{t("legal.terms_liability")}</h3>
            <p>{t("legal.terms_liability_text")}</p>

            <h3 className="font-semibold">{t("legal.terms_accounts")}</h3>
            <p>{t("legal.terms_accounts_text")}</p>
          </div>
